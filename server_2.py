...
# TODO: Transfer binary stream. E.g. 5 secs of Wagner Flight of Valkyries
#
        ...
        if event["type"] == "websocket.connect" :
            ...
            if data_list[0] == "Launch Rocket": # OR: "Terminate?"          
                ...
                while True :
                    ...
                    cfw = current_fuel_weight(counter, int(data_list[4]), int(data_list[3]))
                    ...
                    if counter < 1:               
                        ...
                        # Launched
                        print("{}: Current fuel weight: {}, Total weight: {}, Acceleration: {:.2f}, Altitude: {:.2f}"
                                .format(counter, cfw, trw, a, h))                    
                    #end if   
                    
                    # Send the data to the web-page                                      
                    # The send type can be "text" or "bytes". Send a string of text.                    
                    await send({"type" : "websocket.send", "text" : "{},{},{},{:.2f},{:.2f}"
                                    .format(counter, cfw, trw, a, h) })
